...
ZEM **1.13×**. Hunt range **50–60**. Kunark crypt (Charasis). Needs **Key to Charasis** (Dugroz in Swamp of No Hope, not here). No AAs: wing bosses are a 55 group; **Drusella Sathir** is **2-group**. Wing nameds share PH spots in that wing; each wing’s last-room boss only spawns there.

**IdleQuest** spawn/loot truth: [brynnb/idlequest-content](https://github.com/brynnb/idlequest-content) (`charasis`). Mob names below match IdleQuest display names (`#The_Crypt_Keeper` → **The Crypt Keeper**, `a_crypt_wurm` → **a crypt wurm**). Confirmed loot: **Skeletal Procurator** (~−90, 675) → Mask of Obtenebration; **a crypt wurm** (north ~239, 138 / 387, 80) → Mask of Wurms; **Embalming Fluid** → Fingerbone Hoop / Hand of the Reaper — **not** Enshrouded Veil (Veil is a tiny % on HS trash loottables there).
...
| --- | --- | --- | --- | --- |
| a crypt spectre | SK | South | south named spots | ~50. IdleQuest also has **The Crypt Spectre** (named). Lifetap / Blood Point table |
| a crypt wurm | WAR | North | ~239, 138; 387, 80 | ~48 / ~25% with Bile Sentinel / pulsating bile / crypt golem. Face: **Mask of Wurms** |
| Bile Sentinel | WAR | North | ~239, 138; 387, 80 | ~48 / ~25%. Mucilaginous Girdle / Stein of Tears. Distinct from **Sentient Bile** |
...
| Skeletal Procurator | WAR | West last | ~-90, 675 | ~52. PH a sepulcher skeleton (sometimes bottomless devourer). Skull-engraved Coin after Crypt Keeper. South-wing key. Face: **Mask of Obtenebration** (BRD/ROG) |
| The Crypt Devourer | WAR | — | named spots | ~50. IdleQuest named (also Fabled variant — skip) |
| The Crypt Excavator | WAR | East | east named spots | ~54 |
| The Crypt Feaster | WAR | South | south named spots | ~52 |
| The Crypt Keeper | NEC | North | ~549, 112 | ~50. North boss. Pet. Sigil of the Calendar → west wing |
| The Crypt Spectre | SK | South | south named spots | ~52. Sash of the Dragonborn table (vs lowercase **a crypt spectre**) |
...
| The Spectre Sepulcher | WAR | North / west | ~157, 189; 157, 279 | ~50 / ~50%. Slowable, no summon |
| The Spectre Spiritualist | WAR | South | south named spots | ~54. Highest south named. IdleQuest also has misspelled `the Spectre Spirtualist` PH-tier |
| The Undertaker Lord | SK | East | east last rooms | ~56. Highest HS named before Drusella |
...
| Enshrouded Veil (Face) | HS trash (IdleQuest); Embalming Fluid (P99) | 45–54 | ALL, AC 7 WIS/INT +2 HP/Mana +30 SV FIRE +10. IdleQuest: rare on sepulcher/helot/mortiferous/bottomless/pulsating-bile tables |
...
| Mask of Wurms (Face) | a crypt wurm | 48 | ALL, AC 5 STR/AGI +4 HP +10 Mana +20 |
| Ebonwood Cudgel (1H Blunt) | a crypt wurm | 48 | Non-INT casters, 8/24 (0.33), STR/DEX +5 |
...
| Blood Point (Piercing) | The Crypt Feaster; The Crypt Spectre; a crypt spectre | 50–52 | WAR ROG, 10/21 (0.48), STR +5 CHA −5 SV DISEASE/POISON +10, Siphon proc |
| Steel Hilted Flint Dagger (Piercing) | The Crypt Feaster | 52 | RNG, 4/28 (0.14), Conflagration proc |
| Sash of the Dragonborn (Waist) | The Crypt Spectre | 52 | ALL, AC 2 Haste +24% |
| Golden Bracer (Wrist) | The Crypt Spectre | 52 | ALL except IKS, AC 5 STR/INT +7 |
| Jagged Long Sword (1H Slashing) | The Crypt Spectre | 52 | WAR, 16/30 (0.53) |
...
| Adamantite Armband (Arms) | Howling Spectre | 54 | ALL, AC 3 STR/WIS +3 |
| Obtenebrate Short Sword (1H Slashing) | Howling Spectre | 54 | ROG, 11/24 (0.46), Dooming Darkness proc |
| Rod of Faith (1H Blunt) | Howling Spectre | 54 | PAL, 24/32 (0.75), DEX/CHA +5 |
...
| Item | Mob | Quest |
| --- | --- | --- |
| Mirror of Self-Loathing | Drusella Sathir | **Greenmist** (SK). Hand to **a tormented tradesman** in Dalnir's forge room → Cracked Mirror + Haggle Baron Dalnir |
| Spirit Wracked Urn | Drusella Sathir | **Spirit Wracked Cord** — SHOULDERS/ARMS/WRIST AC 12 STA +5 HP +100 SV COLD +10 SV MAGIC +5, worn **Aura of Battle**. Queen Velazul Di`zok (Chardok) + Undead Dragon Sinew (Sebilis juggernauts / Trakanon) + Regal Band of Bathezid. Ally Brood of Di`Zok. Ring comes back |
| Dusty Iksar Skull | a helot spirit; a helot spectre; an undertaker skeleton | **Iksar shaman skull #7**. Hierophant Granix (Cabilis), then Oracle Qulin (Field of Bone) |
...
| Tallow-marked Candle | a bottomless feaster / a bottomless devourer (zone-in) | North-wing key (or rogue pick) |
...
| Item | Mob | Notes |
| --- | --- | --- |
| Flayed Skin Tome; Satchel of Flayed Skin | Gandan Tailfist | LEAVE. Iksar monk ~52 at the bottom of the entrance fall (~287, -26, -176). Hail for the tome; hand Shackle of Tynnonium (you get it back) for the satchel — he then dies and despawns. No loot. Killing him tanks **Swift Tails** / **Legion of Cabilis**. Whistling Fists |
| Mandala sketch | (ground spawn) | East wing table (~140, -510). Spirit of Garzicor. Not an NPC |
| Key to Charasis | Dugroz | Not in this zone. Swamp of No Hope |
