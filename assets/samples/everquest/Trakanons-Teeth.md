...
Sort the **Mob lookup** table by **Mob** when something is up. Filter also matches any cell (mob, drop, class). **Quest** rows are hand-in NPCs — leave them.
...
| Champion Arlek | Hunter | warrior | Knobbed Warclub (1H Blunt) | All non-casters, WIS +3 |
